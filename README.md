[![GitHub release](https://img.shields.io/github/release/hamoi1/livewire-charts.svg)](https://github.com/hamoi1/livewire-charts/releases/)

![Livewire Charts](https://banners.beyondco.de/Livewire%20Charts.png?theme=light&packageName=hamoi1%2Flivewire-charts&pattern=graphPaper&style=style_1&description=Neat+Livewire+Charts+for+your+Laravel+projects&md=1&fontSize=100px&images=chart-square-bar)

## Preview

![preview](https://github.com/hamoi1/livewire-charts/raw/master/preview.gif)
![preview](./preview_radarchart.gif)

## Demo

https://github.com/hamoi1/livewire-charts-demo
...
```bash
composer require hamoi1/livewire-charts
```
...
![column chart example](https://github.com/hamoi1/livewire-charts/raw/master/column-chart-example.png)
...
``` 
 ...
 ![reactive charts example](https://github.com/hamoi1/livewire-charts/raw/master/reactive-charts-example.gif)
...
- [Muhammad Esmail](https://github.com/hamoi1)
- [Andrés Santibáñez](https://github.com/asantibanez) - Original Author
